...
pd login debian --shared-tmp -- env DISPLAY=:0 wget https://github.com/quydev-fs/Termux_XFCE_for_Vietnamese_timezone/raw/refs/heads/main/libllvm15_15.0.7~++20231019083342+8dfdcc7b7bf6-1~exp1~20231019203418.130_arm64.deb -O libllvm-15_15.0.7_debian_arm64.deb
