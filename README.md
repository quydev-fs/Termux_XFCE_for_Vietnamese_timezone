...
```bash
curl -sL https://raw.githubusercontent.com/quydev-fs/Termux_XFCE_for_Vietnamese_timezone/refs/heads/main/install_xfce_native.sh -o install.sh && bash install.sh
```
